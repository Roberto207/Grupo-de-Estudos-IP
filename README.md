### Grupo-de-Estudos: Introdução à Programação ao Machine Learning

Este repositório reúne os materiais oficiais do Grupo de Estudos de Introdução à Programação ao Machine Learning (IP → ML), incluindo conteúdos preparados pelos organizadores e apresentadores, apresentações, códigos, leituras recomendadas e atividades práticas.

Objetivo do Grupo:

O objetivo principal do grupo é proporcionar uma experiência teórica e principalmente prática de aprendizado, combinando ciência de dados, machine learning e boas práticas de versionamento de código com Git e GitHub, culminando na criação de um projeto profissional de Machine Learning  que possa ser usado no portfólio pessoal de cada participante.

A ideia é que cada membro escolha uma base de dados própria (por exemplo, do Kaggle) e desenvolva, de forma guiada:

Tratamento e análise de dados com Pandas e NumPy.
Visualização e interpretação dos dados com Matplotlib e outras bibliotecas.
...
Encontro 3 – Visualização de Dados e Introdução a ML: Criar gráficos e dashboards para análise exploratória. Introdução ao pré-processamento de dados e às técnicas de Machine Learning.
...
Encontro 6 – Deploy de Projetos de ML: API, salvar com pickle ou joblib,nuvens.